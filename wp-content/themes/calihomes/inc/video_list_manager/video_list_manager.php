...
*/
     ...
     * Define url
     */
    define("TNT_PLUG_PATH", get_template_directory(). '/inc/video_list_manager');
    define("TNT_INC_PATH", TNT_PLUG_PATH."/includes");
    define("TNT_CLASS_PATH", TNT_PLUG_PATH."/includes/models");

    define("TNT_PLUG_URL", get_template_directory_uri()."/inc/video_list_manager");
    ...
    add_action('after_setup_theme','tnt_install_videos_table');
    add_action('after_setup_theme','tnt_install_videos_cat_table');
    add_action('after_setup_theme','tnt_install_videos_type_table');
    add_action('after_setup_theme','tnt_install_data_videos_type_table');
    add_action('after_setup_theme','tnt_install_data_videos_cat_table');
    ...
    add_action('after_setup_theme','tnt_videos_create_options');
    add_action('after_setup_theme','tnt_update_databaseoption_videolistmanager');
?>